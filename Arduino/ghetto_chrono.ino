...
#define IO_OUT(ddr, pins)		IO_SET(ddr, pins)
#define IO_IN(ddr, pins)		IO_CLR(ddr, pins)

//for compatability between ATmega8/8L and ATmega328
#define TIFR					TIFR1
#define TIMSK					TIMSK1
#define TICIE1					ICIE1
...
int main(void) {
	...
	Serial.begin(9600);						//initialize the serial for print
